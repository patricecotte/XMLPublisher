...
<!-- Changed front and back cover templates -->
<xsl:template name="front.cover">
	<xsl:call-template name="page.sequence">
	<xsl:with-param name="master-reference">titlepage</xsl:with-param>
	<xsl:with-param name="force-page-count">end-on-even</xsl:with-param>
	<xsl:with-param name="content">
	<fo:block>
	<fo:external-graphic src="C:/Users/Patrice/workspace/XMLpublisher/input/pdf/images/Patrice Cotte coverpage My Docbook.jpg"
...
<xsl:template name="back.cover">
	...
	<xsl:with-param name="content">
	<fo:block>
	<fo:external-graphic src="C:/Users/Patrice/workspace/XMLpublisher/input/pdf/images/Patrice Cotte backcoverpage.jpg"
		width="100%" height="100%"
		content-height="scale-to-fit" content-width="scale-to-fit"/>
	</fo:block>
	</xsl:with-param>
