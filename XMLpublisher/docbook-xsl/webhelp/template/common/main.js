...
function syncToc(){
    ...
    if (a != undefined) {
        ...
        if (b != undefined) {
            ...
            /* $$$$ Change attributes to suppress the blue background
					and turn the text in red instead of white
            ...
            */
            ...
            if (style != null
					&& !style.match(/background-color: Background;/)) {
				a.setAttribute("style", 
					"background-color: white; " + style);
				b.setAttribute("style", "color: #0050A0;");
			} else if (style != null) {
				a.setAttribute("style",
					"background-color: white; " + style);
				b.setAttribute("style", "color: #0050A0;");
