  ...
  <xsl:template match="/">
    ...
    <xsl:template name="webhelpheader">
        ...
        <div id="header">
            ...
            <h1 align="center">
            	<!-- $$$$ Move the object title after the other one and suppress the BR
                ...
                <!-- $$$$ copied the apply-template here -->
                <xsl:apply-templates select="." mode="object.title.markup"/>
            </h1>
                            ...
                            <td>
                                <xsl:if test="count($prev)>0">
									...
									<a accesskey="h">
										...
										<img class="navicon"
												src="../common/images/Home_green.png" alt="Home"
												height="28" width="28"/>
									</a>
                                    <a accesskey="p">
                                        <xsl:attribute name="href">
                                        ...
                                        <!-- $ $$$Remove the 'Prev' text generation                    
                                        ...
                                        <!-- $$$$ Add the back icon -->
										<img class="navicon"
											src="../common/images/Media-Playback_green.png" alt="Prev"
											height="28" width="28"/>
                               		</a>
                                </xsl:if>
                                ...
                                <xsl:choose>
                                    <xsl:when test="count($up)&gt;0
                                              and generate-id($up) != generate-id($home)">
                                        <!-- $$$$ Removed the vertical separator between the text links (now icons)
                                        |
                                        -->
                                        ...
                                        <a accesskey="u">
                                            ...
                                            <!-- $$$$ Add the Up icon -->
											<img class="navicon" src="../common/images/Up_green.png" alt="Up"
												height="28" width="28"/>
                                        </a>
                                    </xsl:when>
                                    <xsl:otherwise>&#160;</xsl:otherwise>
                                ...
                                <xsl:if test="count($next)>0">
                                    ...
                                    <a accesskey="n">
                                        ...
                                        <!-- $$$$ Remove the 'Next' text generation
                                        <xsl:call-template name="navig.content">
                                        ...
                                        <!-- $$$$ Add the Next icon -->
										<img class="navicon" src="../common/images/Media-Play_green.png" alt="Up"
											height="28" width="28"/>
                                    </a>
                                </xsl:if>
                            </td>
    ...
    <xsl:template name="index.html">
        ...
        <xsl:call-template name="write.chunk">
            ...
            <xsl:with-param name="content">
                <html>
                    <head>
                    	<!-- $$$$ Change the favicon name -->
			            <link rel="shortcut icon" href="PCB inc. favicon.ico"/>
